...
// Both the initial load and the post-save refresh must snapshot these fields identically,
// otherwise the reprocess prompt compares against a differently-shaped baseline.
function processingSettingsFrom(data: any) {
  return {
    title: data.title,
...
export default function ProjectSettingsPage() {
  ...
  const hasRecipientWithEmail = recipients.some((r: any) => r.email && r.email.trim() !== '')
  ...
  useEffect(() => {
    async function loadProject() {
      try {
        ...
        setOriginalSettings(processingSettingsFrom(data))
