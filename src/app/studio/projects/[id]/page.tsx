...
export default function ProjectPage() {
  ...
  return (
    <div className="flex-1 min-h-0 bg-background lg:h-[calc(100dvh-var(--admin-header-height))] lg:overflow-hidden">
      <div className="w-full px-3 py-3 sm:px-4 lg:flex lg:h-full lg:min-h-0 lg:flex-col lg:px-5">
        ...
        <div className="min-h-[calc(100dvh-var(--admin-header-height)-5rem)] border-y border-border lg:min-h-0 lg:flex-1 lg:grid lg:grid-cols-[168px_minmax(0,1fr)_288px]">
